...
const Drawer: FC<DrawerProps> = ({ onOpenChange, open, children }) => {
  return (
    <VDrawer.Root open={open} onOpenChange={onOpenChange}>
      ...
      <VDrawer.Portal>
        <VDrawer.Content className="focus-visible:border-none focus-visible:outline-none fixed flex flex-col bg-white rounded-t-[20px] bottom-0 left-0 right-0 h-full max-h-[80%] mx-[-1px]">
          {children}
        </VDrawer.Content>
      </VDrawer.Portal>
    </VDrawer.Root>
