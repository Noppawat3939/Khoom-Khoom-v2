  ...
  return (
    ...
    >
      ...
      <section
        ...
        className="gap-5 max-md:gap-4 min-w-[85%] max-md:max-h-[55%] justify-center max-sm:min-w-[95%] grid grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:overflow-y-auto max-sm:grid-cols-1 max-sm:space-y-3 max-sm:p-1 max-sm:max-h-full"
      >
